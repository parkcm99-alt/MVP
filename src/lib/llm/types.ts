...
export interface AgentTelemetry {
  ...
  inputTokens?: number | null;
  outputTokens?: number | null;
  /** Sanitized reason, returned only outside production. */
  debugReason?: string;
}
...
export type SpecialistAgentRole = 'architect' | 'developer' | 'reviewer' | 'qa';
export type SpecialistAgentResponse =
  | ArchitectAgentResponse
  | DeveloperAgentResponse
  | ReviewerAgentResponse
  | QaAgentResponse;
export type AnyAgentResponse = PlannerAgentResponse | SpecialistAgentResponse;
