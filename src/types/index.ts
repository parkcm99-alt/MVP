...
export interface SimTask {
  ...
  createdAt: number;
  updatedAt: number;
  /** Client-side context only; the Supabase tasks schema stays unchanged. */
  sessionId?: string;
  origin?: 'simulation' | 'planner-generated' | 'debug-finding';
  localOnly?: boolean;
}
...
export interface SimEvent {
  ...
  type: EventType;
  message: string;
  /** Derived/debug context only; events still persist through the existing adapter. */
  sessionId?: string;
